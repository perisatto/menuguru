package com.perisatto.fiapprj.menuguru.hexagonal.product.domain.service;
...
public class ProductService implements ManageProductUseCase{
	...
	public Product updateProduct(Long id, String name, String type, String description, Double price, String image) throws Exception {
		Optional<Product> oldProductData = manageProductPort.getProductById(id);
		if(oldProductData.isPresent()) {
			...
			Optional<Product> updatedProductData = manageProductPort.updateProduct(newProductData);
	...
	public Boolean deleteProduct(Long id) throws Exception {
		...
		Optional<Product> product = manageProductPort.getProductById(id);		
		if(product.isPresent()) {
			deleted = manageProductPort.deleteProduct(id);
